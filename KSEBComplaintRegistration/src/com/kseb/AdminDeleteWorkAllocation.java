...
@WebServlet("/DeleteWorkAllocation")
public class AdminDeleteWorkAllocation extends HttpServlet{
	Connection con = null;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			pst = con.prepareStatement("delete from work_allocation where allocation_id=?");
			pst.setInt(1, id);
