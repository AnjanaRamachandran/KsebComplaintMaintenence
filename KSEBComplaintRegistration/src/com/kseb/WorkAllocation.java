	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		HttpSession session=request.getSession(false);
			...
			try {
				...
				pst = con.prepareStatement("select complaint_id from complaint_details ");
			...
			out.print("<h1>New Work Allocation</h1>");
			...
			out.print("</select><br><br>");
			/*out.print("<label for='status'>Work Status</label>");
			...
			con = dbcon1.getConnection();
			pst1 = con.prepareStatement("select allocation_id,allocation_date,complaint_id,lineman from work_allocation");
			rs1=pst1.executeQuery();
			out.print("<h2>Work Allocation Details</h2>");
